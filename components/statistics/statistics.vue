<template>
  <div class="bg-grey text-dark p-4 rounded-lg">
    <!-- Titel en info -->
    <div class="flex justify-between">
      <h4>Statistics</h4>
      <svg xmlns="http://www.w3.org/2000/svg" class="flex-none w-5 fill-current text-dark-grey" viewBox="0 0 24 24">
        <path
    ...
    <!-- User your solutions -->
    <StatisticsProgress :current-impact="userTotalImpact" :action="'have used your solutions'"></StatisticsProgress>
